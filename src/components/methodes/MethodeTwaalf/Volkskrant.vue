...
import VolkskrantGoogleFb from '../../data-fb/VolkskrantFb'
  ...
  data() {
    return {
      flowers: [
		  {
          name: "Facebook",
          amount: VolkskrantGoogleFb.search_information.total_results,
          color: '#4267b2'
          },
          {
          name: "Eigen Site",
          amount: VolkskrantGoogleSite.search_information.total_results,
          color: '#1f2544'
          },
          {
          name: "Twitter",
